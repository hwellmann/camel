...
import org.apache.camel.component.sjmsee.consumer.AbstractMessageHandler;
import org.apache.camel.component.sjmsee.consumer.InOnlyMessageHandler;
import org.apache.camel.component.sjmsee.consumer.InOutMessageHandler;
...
import org.apache.camel.component.sjmsee.jms.ObjectPool;
import org.apache.camel.component.sjmsee.taskmanager.TimedTaskManager;
import org.apache.camel.component.sjmsee.tx.BatchTransactionCommitStrategy;
import org.apache.camel.component.sjmsee.tx.DefaultTransactionCommitStrategy;
import org.apache.camel.component.sjmsee.tx.SessionBatchTransactionSynchronization;
...
public class SjmsConsumer extends DefaultConsumer {
    ...
    protected class MessageConsumerPool extends ObjectPool<MessageConsumerResources> {
         ...
         *
         * @see org.apache.camel.component.sjmsee.jms.ObjectPool#createObject()
         */
        @Override
         ...
         *
         * @see org.apache.camel.component.sjmsee.jms.ObjectPool#destroyObject(java.lang.Object)
         */
        @Override
    ...
    protected class MessageConsumerResources implements ExceptionListener {
    ...
    protected void doStart() throws Exception {
        ...
        consumers.fillPool();
        reconnectTask = executor.submit(new Runnable() {
    ...
    protected void doStop() throws Exception {
        ...
        log.info("cancelled reconnect: {}", cancelled);
        if (consumers != null) {
            consumers.drainPool();
            consumers = null;
        }
    ...
    private MessageConsumerResources createConsumer() throws Exception {
        ...
        try {
            ...
            MessageListener handler = createMessageHandler(conn, session);
            ...
            conn.setExceptionListener(answer);
        } catch (Exception e) {
     ...
     * @return the listener
     */
    protected MessageListener createMessageHandler(Connection conn, Session session) {
        ...
        if (commitStrategy instanceof BatchTransactionCommitStrategy) {
            ...
            synchronization = new SessionTransactionSynchronization(conn, session, commitStrategy);
        }
