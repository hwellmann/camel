...
import org.apache.camel.component.sjmsee.SjmsExchangeMessageHelper;
...
public class InOutProducer extends SjmsProducer {
    ...
    private MessageProducerResources createProducer() throws Exception {
        ...
        try {
            ...
            answer = new MessageProducerResources(conn, session, messageProducer);
    ...
    protected MessageConsumerResource createConsumer(Session session) throws Exception {
        MessageConsumerResource answer = null;
        try {
     ...
     * 
     * @see org.apache.camel.component.sjmsee.SjmsProducer#sendMessage(org.apache.camel.Exchange,
    ...
    public void sendMessage(final Exchange exchange, final AsyncCallback callback) throws Exception {
        if (true) {
            ...
            if (producer != null) {
                ...
                if (isEndpointTransacted()) {
                    exchange.getUnitOfWork().addSynchronization(new SessionTransactionSynchronization(producer.getConnection(), producer.getSession(), getCommitStrategy()));
                }
                ...
                MessageConsumerResource consumer = createConsumer(producer.getSession());
